#!/usr/bin/env bash
# Teacher Network
python run.py --epochs 40 --lr_decay_epochs 25 30 35 --lr_decay_gamma 0.5 --batch 32 --base resnet50 --sample distance --margin 0.2 --embedding_size 512 --split_r 250 --save_dir cifar100_resnet50_512_250k

python run.py --epochs 40 --lr_decay_epochs 25 30 35 --lr_decay_gamma 0.5 --batch 32 --base resnet50 --sample distance --margin 0.2 --embedding_size 512 --split_r 250 --save_dir cifar100_resnet50_512_250k --mode eval > txt_out/cifar100_resnet50_512_250k.txt
